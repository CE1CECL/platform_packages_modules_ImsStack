...
public class CarrierConfig {
    ...
    // This key is a config that stores the carrier-config of the last inserted SIM and
    // indicates whether it can be used in the no SIM case.
    public static final String KEY_IMS_USE_CONFIG_OF_LAST_INSERTED_SIM_WHEN_NO_SIM_BOOL =
            "ims.use_config_of_last_inserted_sim_when_no_sim_bool";
    ...
    public static final String[] IMS_PREFIX_KEYS = {
        ...
        KEY_IMS_USE_CONFIG_OF_LAST_INSERTED_SIM_WHEN_NO_SIM_BOOL,
    ...
    public static class Ims {
        ...
        public static final String KEY_KEEP_EXISTING_PCSCF_ON_PCSCF_CHANGE_DURING_THE_CALL_BOOL =
                KEY_PREFIX + "keep_existing_pcscf_on_pcscf_change_during_the_call_bool";
        ...
        public static final String KEY_REG_RETRY_CNT_PER_PCSCF_WITH_RA_TIME_INT =
                KEY_PREFIX + "reg_retry_cnt_per_pcscf_with_ra_time_int";
    ...
    public static class ImsEmergency {
        ...
        public static final String KEY_PLMNS_RELEASE_EPDN_UPON_ECALL_END_IN_FAKE_MODE_STRING_ARRAY =
                KEY_PREFIX + "plmns_release_epdn_upon_ecall_end_in_fake_mode_string_array";
        // Mtc
    ...
    public static class ImsSms {
        ...
        public static final String KEY_SMS_EVALUATE_RADIO_STATUS_FOR_RP_ERROR_CAUSES_INT_ARRAY =
                KEY_PREFIX + "sms_evaluate_radio_status_for_rp_error_causes_int_array";
    ...
    public static class ImsVoice {
        ...
        public static final String KEY_WAIT_QOS_FOR_INCOMING_INVITE_WITHOUT_PRECONDITION_BOOL =
                KEY_PREFIX + "wait_qos_for_incoming_invite_without_precondition_bool";
