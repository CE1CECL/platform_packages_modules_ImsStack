...
public class SipDelegateImpl implements SipDelegate , ISipDelegateIncomingMessageNotifier {
    ...
    public void sendMessage(@NonNull SipMessage message, long configVersion) {
        ...
        if (!isFeatureTagSupported(SipMessageParsingUtils.getAcceptContactFeatureTags
    ...
    public void cleanupSession(@NonNull String callId) {
        ...
        //TODO clean up the session associated with this callID.
        //Native API to clean up the session associated with call id.
    }
    /**
    ...
    public void notifyMessageReceived(@NonNull String viaTransactionId) {
        ...
        //TODO. Check with native team whether  any interface required them notify the received msg.
        //This API may be required for the native to send successful message received response.
    }
    /**
    ...
    private DelegateRegistrationState getSipDelegateRegistrationStateObject(
        ...
        //De registered tags
        for(FeatureTagState deregisteredFeatureTag: registrationState.getDeregisteredFeatureTags()){
