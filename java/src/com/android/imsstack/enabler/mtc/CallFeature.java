...
public final class CallFeature {
    ...
    public static ConfigAgent getConfigAgent(int slotId) {
        return (ConfigAgent) AgentFactory.getInstance().getAgent(
                ConfigInterface.class, slotId);
    }

    public static int getStatusCodeforCallTypeChangeReject(int slotId) {
        return getConfigAgent(slotId).getCarrierConfig().getInt(
    ...
    public static boolean isAudioEvsSupported(int slotId) {
        return FeatureUtils.isMediaEvsSupported(ImsGlobal.getInstance());
    }

    public static boolean isCallHoldUsingInactive(int slotId) {
        return getConfigAgent(slotId).getCarrierConfig()
    ...
    public static boolean isSrvccSupported(int slotId) {
        int[] srvccType = getConfigAgent(slotId).getCarrierConfig()
