...
public class IUMtcService {
    ...
    public static final int SET_TERMINAL_BASED_TIR          = (EVENT_U2I + 7);
    public static final int OPEN_EMERGENCY_SERVICE          = (EVENT_U2I + 8);
    public static final int STOP_EMERGENCY_SERVICE          = (EVENT_U2I + 9);
    public static final int TEST_COMMAND                    = (EVENT_U2I + 10);
