...
public:
    ...
    static const IMS_SINT32 SET_TERMINAL_BASED_TIR = (EVENT_U2I + 7);
    static const IMS_SINT32 OPEN_EMERGENCY_SERVICE = (EVENT_U2I + 8);
    static const IMS_SINT32 STOP_EMERGENCY_SERVICE = (EVENT_U2I + 9);
    static const IMS_SINT32 TEST_COMMAND = (EVENT_U2I + 10);
