...
public:
    inline MediaInfo()
        ...
        , eGTTMode(-1)
    {
        IMS_TRACE_MEM("uc", "uc_M : MediaInfo[%" PFLS_u "][%" PFLS_x "]", sizeof(MediaInfo), this,
                0);
    }
    ...
    inline ~MediaInfo()
    {
        IMS_TRACE_MEM("uc", "uc_F : MediaInfo[%" PFLS_u "][%" PFLS_x "]", sizeof(MediaInfo), this,
                0);
    }
...
public:
    inline SuppService()
        ...
        , bValue(IMS_FALSE)
    {
        IMS_TRACE_MEM("uc", "uc_M : SuppService[%" PFLS_u "][%" PFLS_x "]", sizeof(SuppService),
                this, 0);
    }
    ...
    inline ~SuppService()
    {
        IMS_TRACE_MEM("uc", "uc_F : SuppService[%" PFLS_u "][%" PFLS_x "]", sizeof(SuppService),
                this, 0);
    }
...
public:
    ...
    {
        IMS_TRACE_MEM("uc", "uc_M : Recipient[%" PFLS_u "][%" PFLS_x "]", sizeof(Recipient), this,
                0);
    }
    ...
    inline ~Recipient()
    {
        IMS_TRACE_MEM("uc", "uc_F : Recipient[%" PFLS_u "][%" PFLS_x "]", sizeof(Recipient), this,
                0);
    }
...
public:
    inline DialogInfo()
        ...
        , pMediaInfo(IMS_NULL)
    {
        IMS_TRACE_MEM("uc", "uc_M : DialogInfo[%" PFLS_u "][%" PFLS_x "]", sizeof(DialogInfo),
                this, 0);
    }
    ...
    inline ~DialogInfo()
    {
        IMS_TRACE_MEM("uc", "uc_F : DialogInfo[%" PFLS_u "][%" PFLS_x "]", sizeof(DialogInfo),
                this, 0);
