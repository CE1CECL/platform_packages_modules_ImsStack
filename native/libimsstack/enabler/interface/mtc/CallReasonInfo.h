...
enum
{
    ...
    EXTRA_CODE_REDIAL_BY_EPS_FALLBACK = 5,
    EXTRA_CODE_REDIAL_EMERGENCY_WITH_NEXT_PCSCF = 6,
    EXTRA_CODE_REDIAL_WITH_NEXT_PCSCF = 7,
    EXTRA_CODE_REDIAL_BY_RTT_EMERGENCY_REJECTION = 8,
};
