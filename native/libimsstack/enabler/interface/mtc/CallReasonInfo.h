...
enum
{
    ...
    CODE_EMERGENCY_CALL_OVER_WFC_NOT_AVAILABLE = 1622,
...
enum
{
    ...
    EXTRA_CODE_REDIAL_BY_ERROR_RESPONSE = 2,
    EXTRA_CODE_REDIAL_FOR_REDIRECTION = 3,
    EXTRA_CODE_REDIAL_FOR_SDP_CHANGE = 4,  // TODO: just full capa or reflect SDP contents
    EXTRA_CODE_REDIAL_AFTER_EPS_FALLBACK = 5,
    EXTRA_CODE_REDIAL_BY_EPS_FALLBACK = 6,
    EXTRA_CODE_REDIAL_EMERGENCY_WITH_NEXT_PCSCF = 7,
    EXTRA_CODE_REDIAL_WITH_NEXT_PCSCF = 8,
    EXTRA_CODE_REDIAL_BY_RTT_EMERGENCY_REJECTION = 9,
};
...
enum
{
    ...
    EXTRA_CODE_NOT_ACCEPTABLE_BY_VOPS = 4,
};
