...
// subscribe info
class IUceSingleSubCmdPrm
{  // UCE_SEND_SINGLE_SUBSCRIBE_CMD
public:
...
class IUceOptionsCmdPrm
{  // UCE_SEND_OPTIONS_CMD
public:
...
class IUceOptionsRespCmdPrm
{  // UCE_SEND_OPTIONS_RESP_CMD
public:
...
class IUcePubResponseIndPrm
{  // UCE_PUBLISH_RESPONSE_IND
public:
...
class IUcePubUpdatedIndPrm
{  // UCE_PUBLISH_UPDATED_IND
public:
...
class IUcePubCmdErrorIndPrm
{  // UCE_PUBLISH_CMD_ERROR_IND
public:
...
class IUceSubResponseIndPrm
{  // UCE_SUBSCRIBE_RESPONSE_IND
public:
...
class IUcePreNotifyIndPrm
{  // UCE_PRESENCE_NOTIFY_IND
public:
...
class IUceSubCmdErrorIndPrm
{  // UCE_SUBSCRIBE_CMD_ERROR_IND
public:
...
class IUceSubResourceTerminatedIndPrm
{  // UCE_SUBSCRIBE_RESOURCE_TERMINATED_IND
public:
...
class IUceSubTerminatedIndPrm
{  // UCE_SUBSCRIBE_TERMINATED_IND
public:
...
class IUceOptionsResponseIndPrm
{  // UCE_OPTIONS_RESPONSE_IND
public:
...
class IUceOptionsCmdErrorIndPrm
{  // UCE_OPTIONS_CMD_ERROR_IND
public:
...
class IUceOptionsReceivedIndPrm
{  // UCE_OPTIONS_RECEIVED_IND
public:
