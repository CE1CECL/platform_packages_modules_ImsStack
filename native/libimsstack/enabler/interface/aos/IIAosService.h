...
public:
    ...
    static const IMS_SINT32 N2J_NOTIFY_TECHNOLOGY_CHANGE_FAILED = EVENT_N2J + 4;
    static const IMS_SINT32 N2J_NOTIFY_ASSOCIATED_URI_CHANGED = EVENT_N2J + 5;
    static const IMS_SINT32 N2J_NOTIFY_CAPABILITIES_UPDATE_FAILED = EVENT_N2J + 6;

    /// AosService(Native) -> IAosInfoListener(Java)
    static const IMS_SINT32 N2J_NOTIFY_AOS_ISIM_STATE = EVENT_N2J_INFO + 1;
    static const IMS_SINT32 N2J_NOTIFY_REG_EVENT_STATE = EVENT_N2J_INFO + 2;
    static const IMS_SINT32 N2J_REQUEST_PHONE_NUMBER_RETRY = EVENT_N2J_INFO + 3;
    static const IMS_SINT32 N2J_REQUEST_WIFI_SERVICE = EVENT_N2J_INFO + 4;
};
