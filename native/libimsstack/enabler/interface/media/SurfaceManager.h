...
#ifndef _SURFACE_MANAGER_H_
#define _SURFACE_MANAGER_H_
...
private:
    SurfaceManager(IN const SurfaceManager& objRHS);
    SurfaceManager& operator=(IN const SurfaceManager& objRHS);
...
private:
    SurfaceManagerPrivate* pPrivate;
};

#endif // _SURFACE_MANAGER_H_
