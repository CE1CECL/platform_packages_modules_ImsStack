...
IMS_BOOL UceOptions::SendOptionsResponse(IN IMS_UINT32 nResponse, IN AString reason,
...
PROTECTED VIRTUAL
void UceOptions::CapabilityQueryDelivered(IN ICapabilities* piCapabilities_)
{
...
PROTECTED VIRTUAL
void UceOptions::CapabilityQueryDeliveryFailed(IN ICapabilities *piCapabilities_)
{
