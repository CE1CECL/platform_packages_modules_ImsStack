...
PUBLIC VIRTUAL
UceSubscribeManager::~UceSubscribeManager()
{
...
{
    UceSubscribe* pUceSubscribe  = new UceSubscribe(m_piCoreService, m_strAppName, GetName(),
...
PROTECTED VIRTUAL
IMS_BOOL UceSubscribeManager::OnMessage( IN IMSMSG &objMsg )
{
