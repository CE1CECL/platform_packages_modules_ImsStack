#ifndef _INTERFACE_AOS_REGISTRATION_H_
#define _INTERFACE_AOS_REGISTRATION_H_
...
public:
    ...
    enum
    {
        ...
        REASON_SET_VOPS_ENABLE,
        REASON_SET_VOPS_DISABLE,

        REASON_SET_VIDEO_CAPA_ENABLE,
        REASON_SET_VIDEO_CAPA_DISABLE,

        REASON_SET_DELAY_CLEAR_SOCKET_ENABLE,
        REASON_SET_DELAY_CLEAR_SOCKET_DISABLE
    };
...
#endif // _INTERFACE_AOS_REGISTRATION_H_
