...
#ifndef _CODEC_H265_CONFIG_H_
#define _CODEC_H265_CONFIG_H_

#include "config/CodecConfig.h"

class CodecH265Config :
        public CodecConfig
{
public:
    CodecH265Config(IN IMS_SINT32 nProfielNum_);
    virtual ~CodecH265Config();

private:
    CodecH265Config(IN CONST CodecH265Config &objRHS);
    CodecH265Config& operator=(IN CONST CodecH265Config &objRHS);
