...
// Camera output memory align
    ...
    || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8926) || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8994) \
    || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8992) || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8909) \
    || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8996) || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8916) \
    || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8952) || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8937) \
    || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8976) || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8917) \
    || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8940) || defined(MMPF_CHIPSET_CATEGORY_QCT_MSM8998) \
    || defined(MMPF_CHIPSET_CATEGORY_QCT_SDM845) || defined(MMPF_CHIPSET_CATEGORY_QCT_SDM450) \
