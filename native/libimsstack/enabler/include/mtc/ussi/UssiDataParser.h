...
public:
    ...
    public:
        inline IMS_UINT32 GetUSSType() const
            { return m_nUSSType; }
        inline IMS_SINT32 GetAlertingPattern() const
            { return m_nAlertingPattern; }
...
public:
    ...
    inline const AString& GetLanguage() const
        { return m_strLanguage; }
    inline const AString& GetUSSDString() const
        { return m_strUSSDString; }
    inline IMS_UINT32 GetErrorCode() const
        { return m_nErrorCode; }
private:
