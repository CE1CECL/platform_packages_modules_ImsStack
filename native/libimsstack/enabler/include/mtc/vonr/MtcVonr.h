...
public:
    ...
    enum class VonrInitType
    {
        NONE,
        LTE,
        NR,
        WIFI,
        EMERGENCY /* differently defined?*/
    };
...
public:
    ...
    virtual void VoNrHandoff_NotifyInformation(IN IMS_UINT32 nStatus, IN IMS_UINT32 nSourceRAT,
            IN IMS_UINT32 nTargetRAT, IN IMS_SINT32 nReason);
...
protected:
    ...
    enum
    {
        TIME_WAIT_UAC_RESPONSE = 3000
    };
    enum
    {
        TIME_WAIT_CALL_READY = 5000
    };
