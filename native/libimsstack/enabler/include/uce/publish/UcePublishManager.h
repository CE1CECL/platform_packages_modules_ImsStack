...
private:
    ...
    // If TMUS supports the encoded body, the pidf xml must be gzipped. If a publish request with a
    // compressed body fails, the publish request is retried with the original body.
