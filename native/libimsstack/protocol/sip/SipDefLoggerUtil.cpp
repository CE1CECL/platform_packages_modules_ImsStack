 ...
 * NOTE             :
 ******************************************************************************/
void SipDefLoggerUtil::DumpLog
(
  SIP_UINT32 nCategory,
  const SIP_CHAR * /*pszFile*/, SIP_UINT16 /*nLine*/,
  const SIP_CHAR *pszFormat, ...
)
{
    if ( TraceService::GetTraceService()->GetTrace()->IsTraceEnabled(nCategory, __IMS_TRACE_MODULE__) )
    {
        va_list args;
