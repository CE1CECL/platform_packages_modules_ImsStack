...
#define IS_HEXDIG(ch) (((ch) >= 65 && (ch) <= 70) || ((ch) >= 97 && (ch) <= 102) || IS_DIGIT((ch)))
...
#define IS_MARK(ch) (((ch) == '-') || ((ch) == '_')||\
        ((ch) == '.') || ((ch) == '!') || ((ch) == '~') ||\
        ((ch) == '*') || ((ch) == '(') || ((ch) == ')') || ((ch) == 39))

#define IS_RESERVED(ch) (((ch) == ';') || ((ch) == '/') ||\
        ((ch) == '?') || ((ch) == ':') || ((ch) == '@') ||\
        ((ch) == '&') || ((ch) == '=') || ((ch) == '+') ||\
        ((ch) == '$') || ((ch) == ','))
...
#define IS_PCHAR(ch) (((ch) == ':') || ((ch) == '@') ||\
        ((ch) == '&') || ((ch) == '=')  || ((ch) == '+') ||\
        ((ch) == '$') || ((ch) == ','))

#define IS_URIC_NO_SLASH(ch) (((ch) == ';') ||\
        ((ch) == '?') || ((ch) == ':') || ((ch) == '@') ||\
        ((ch) == '&') || ((ch) == '=') || ((ch) == '+') ||\
        ((ch) == '$') || ((ch) == ','))

#define IS_SEPARATORS(ch) (((ch) == '(') || ((ch) == '/') ||\
        ((ch) == '?') || ((ch) == ':') || ((ch) == '@') ||\
        ((ch) == '&') || ((ch) == '=') || ((ch) == '+') ||\
        ((ch) == '$') || ((ch) == ','))
...
#define IS_PASSWORD(ch) (((ch) == '&') || ((ch) == '=') ||\
        ((ch) == '+') || ((ch) == '$') || ((ch) == ','))

#define IS_REGNAME(ch) (((ch) == '$') || ((ch) == ',') ||\
        ((ch) == ';') || ((ch) == ':') || ((ch) == '@') ||\
        ((ch) == '&') || ((ch) == '=') || ((ch) == '+'))

#define IS_USER_UNRESERVED(ch) (((ch) == '&') || ((ch) == '=') ||\
        ((ch) == '+') || ((ch) == '$') || ((ch) == ',') ||\
        ((ch) == ';') || ((ch) == '?') || ((ch) == '/'))

#define IS_TOKEN(ch) (IS_ALPHANUM((ch))  ||((ch) == '-') ||\
        ((ch) == '.') || ((ch) == '!') || ((ch) == '%') ||\
        ((ch) == '_') || ((ch) == '+') || ((ch) == '`') ||\
        ((ch) == '\'') || ((ch) == '~') || ((ch) == '*'))

#define IS_TOKEN_NO_BANG(ch) (IS_ALPHANUM((ch))  ||((ch) == '-') ||\
        ((ch) == '.')|| ((ch) == '%') ||\
        ((ch) == '_') || ((ch) == '+') || ((ch) == '`') ||\
        ((ch) == '\'') || ((ch) == '~') || ((ch) == '*'))

#define IS_TOKEN_NO_DOT(ch) (IS_ALPHANUM((ch))  ||((ch) == '-') ||\
        ((ch) == '!') || ((ch) == '%') ||\
        ((ch) == '_') || ((ch) == '+') || ((ch) == '`') ||\
        ((ch) == '\'') || ((ch) == '~') || ((ch) == '*'))
...
#define IS_WORD(ch) (IS_TOKEN((ch)) ||((ch) == '(') || ((ch) == ')') ||\
        ((ch) == '<') || ((ch) == '>') || ((ch) == ':') ||\
        ((ch) == '\\') || ((ch) == '"') || ((ch) == '/') ||\
        ((ch) == '[') || ((ch) == ']') || ((ch) == '?') ||\
        ((ch) == '{') || ((ch) == '}'))

#define IS_HNV_UNRESERVED(ch) (((ch) == '[') || ((ch) == ']')||\
        ((ch) == '/') || ((ch) == '?') || ((ch) == ':') ||\
        ((ch) == '+') || ((ch) == '$'))


#define IS_ESCAPED(ch1, ch2, ch3) (((ch1) == '%')  && (IS_HEXDIG((ch2))) &&\
        (IS_HEXDIG((ch3))))

#define IS_SCHEME(ch) (IS_ALPHANUM((ch)) || ((ch) == '+') || ((ch) == '-') || ((ch) == '.'))
#define SIP_COLLECT_TEMP_POS(pch1, pch2) (pch1) = (pch2); (pch2) = SIP_NULL


#define IS_QdText(ch) ( (ch == 0x21) || ((ch >= 0x23) && (ch <= 0x5B)) ||\
        ((ch >= 0x5D) && (ch <= 0x7E)))

#define IS_QdTextNoAbkt(ch) ( (ch == 0x21) || ((ch >= 0x23) && (ch <= 0x3B)) || (ch == 0x3D)||\
        ((ch >= 0x3F) && (ch <= 0x5B)) || ((ch >= 0x5D) && (ch <= 0x7E)))

#define IS_QUOTED_PAIR(ch) (((((SIP_CHAR)ch) >= 0x00) && (((SIP_CHAR)ch) <= 0x09)) ||\
...
#define IS_CTEXT(ch) ( ( ((ch)>=0x21) && ((ch)<=0x27) ) ||  ( ((ch)>=0x2A) && ((ch)<=0x5B) )  ||\
        ( ((ch)>=0x5D) && ((ch)<=0x7E) ))
