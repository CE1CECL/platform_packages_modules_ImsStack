...
PUBLIC VIRTUAL
IMS_SINT32 NamedNodeMap::GetLength() const
{
    return m_objNamedItems.GetSize();
}

PUBLIC VIRTUAL
INode* NamedNodeMap::GetNamedItem(IN const AString& strName) const
{
...
PUBLIC VIRTUAL
INode* NamedNodeMap::GetNamedItemNs(IN const AString& strNamespaceUri,
...
PUBLIC VIRTUAL
INode* NamedNodeMap::Item(IN IMS_SINT32 nIndex) const
{
...
PUBLIC VIRTUAL
INode* NamedNodeMap::RemoveNamedItem(IN const AString& strName)
{
    (void)strName;
    return IMS_NULL;
}
...
PUBLIC VIRTUAL
INode* NamedNodeMap::RemoveNamedItemNs(IN const AString& strNamespaceUri,
...
PUBLIC VIRTUAL
INode* NamedNodeMap::SetNamedItem(IN INode* piNode)
{
    (void)piNode;
    return IMS_NULL;
}
...
PUBLIC VIRTUAL
INode* NamedNodeMap::SetNamedItemNs(IN INode* piNode)
{
    (void)piNode;
    return IMS_NULL;
}
