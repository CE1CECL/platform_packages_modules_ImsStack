...
private:
    ...
    public:
        inline const AString& GetPrefix() const
        { return m_strPrefix; }
        inline const AString& GetUri() const
        { return m_strUri; }
    ...
    public:
        inline const AString& GetLocalName() const
...
public:
    ...
    IMS_RESULT WriteEmptyElement(IN const AString& strNamespaceUri,
            IN const AString& strLocalName) override;
    IMS_RESULT WriteEmptyElement(IN const AString& strPrefix,
            IN const AString& strLocalName, IN const AString& strNamespaceUri) override;
    inline void WriteEndDocument() override
    {}
    IMS_RESULT WriteEndElement() override;
    IMS_RESULT WriteNamespace(IN const AString& strPrefix,
            IN const AString& strNamespaceUri) override;
    inline IMS_RESULT WriteStartDocument() override
    { return WriteStartDocument("UTF-8", "1.0"); }
    IMS_RESULT WriteStartDocument(IN const AString& strVersion) override;
    IMS_RESULT WriteStartDocument(IN const AString& strEncoding,
            IN const AString& strVersion) override;
    ...
    IMS_RESULT WriteStartElement(IN const AString& strNamespaceUri,
            IN const AString& strLocalName) override;
    IMS_RESULT WriteStartElement(IN const AString& strPrefix,
            IN const AString& strLocalName, IN const AString& strNamespaceUri) override;
    ...
    IMS_RESULT WriteAttribute(IN const IMS_CHAR* pszLocalName,
            IN const IMS_CHAR* pszValue) override;
    IMS_RESULT WriteAttribute(IN const IMS_CHAR* pszNamespaceUri,
            IN const IMS_CHAR* pszLocalName, IN const IMS_CHAR* pszValue) override;
    IMS_RESULT WriteAttribute(IN const IMS_CHAR* pszPrefix,
    ...
    IMS_RESULT WriteEmptyElement(IN const IMS_CHAR* pszNamespaceUri,
            IN const IMS_CHAR*pszLocalName) override;
    IMS_RESULT WriteEmptyElement(IN const IMS_CHAR* pszPrefix,
            IN const IMS_CHAR* pszLocalName, IN const IMS_CHAR* pszNamespaceUri) override;
    IMS_RESULT WriteNamespace(IN const IMS_CHAR* pszPrefix,
            IN const IMS_CHAR* pszNamespaceUri) override;
    IMS_RESULT WriteStartDocument(IN const IMS_CHAR* pszVersion) override;
    IMS_RESULT WriteStartDocument(IN const IMS_CHAR* pszEncoding,
            IN const IMS_CHAR* pszVersion) override;
    IMS_RESULT WriteStartElement(IN const IMS_CHAR* pszLocalName) override;
    IMS_RESULT WriteStartElement(IN const IMS_CHAR* pszNamespaceUri,
            IN const IMS_CHAR* pszLocalName) override;
    IMS_RESULT WriteStartElement(IN const IMS_CHAR* pszPrefix,
            IN const IMS_CHAR* pszLocalName, IN const IMS_CHAR* pszNamespaceUri) override;
    inline IMS_SINT32 GetContentLength() const override
    { return m_strXml.GetLength(); }
    inline const XmlError* GetLastError() const override
    { return m_pError; }

private:
    XmlPrefix* GetPrefixInternal(IN const AString& strUri) const;
    inline IMS_BOOL IsOperationFailedAtLeastOnce() const
    { return (m_pError != IMS_NULL); }
