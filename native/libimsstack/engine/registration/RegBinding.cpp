...
void RegBinding::UpdateContact(IN IRegContact *piContact)
{
    ...
    if ((this->piContact != IMS_NULL)
            && this->piContact->IsActiveBinding())
    {
...
PROTECTED VIRTUAL
void RegBinding::Update(IN IMS_SINT32 nWhat)
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
const AStringArray& RegBinding::GetAssociatedURIs() const
{
    //---------------------------------------------------------------------------------------------
    ...
    return (piRegEx != IMS_NULL) ?
            piRegEx->GetStateTracker()->GetAssociatedURIs() : AStringArray::ConstNull();
}
...
PROTECTED VIRTUAL
const IPAddress& RegBinding::GetIPAddress() const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
const AStringArray& RegBinding::GetPathHeaders() const
{
    //---------------------------------------------------------------------------------------------
    ...
    return (piRegEx != IMS_NULL) ?
            piRegEx->GetStateTracker()->GetPathHeaders() : AStringArray::ConstNull();
}

PROTECTED VIRTUAL
IMS_SINT32 RegBinding::GetPortFlowControl() const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
IMS_SINT32 RegBinding::GetPortUC() const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
IMS_SINT32 RegBinding::GetPortUS() const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
const IRegInfo* RegBinding::GetRegInfo() const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
const AStringArray& RegBinding::GetSecurityClients() const
{
    //---------------------------------------------------------------------------------------------
    ...
    return (piRegEx != IMS_NULL) ?
            piRegEx->GetStateTracker()->GetSecurityClients() : AStringArray::ConstNull();
}

PROTECTED VIRTUAL
const AStringArray& RegBinding::GetSecurityVerifys() const
{
    //---------------------------------------------------------------------------------------------
    ...
    return (piRegEx != IMS_NULL) ?
            piRegEx->GetStateTracker()->GetSecurityVerifys() : AStringArray::ConstNull();
}

PROTECTED VIRTUAL
const AStringArray& RegBinding::GetServiceRoutes() const
{
    //---------------------------------------------------------------------------------------------
    ...
    return (piRegEx != IMS_NULL) ?
            piRegEx->GetStateTracker()->GetServiceRoutes() : AStringArray::ConstNull();
}
...
PROTECTED VIRTUAL
IMS_SINT32 RegBinding::GetState() const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
const AString& RegBinding::GetSubscriberId() const
{
    //---------------------------------------------------------------------------------------------

    return (piRegEx != IMS_NULL) ?
            piRegEx->GetStateTracker()->GetSubscriberId() : AString::ConstNull();
}

PROTECTED VIRTUAL
IMS_SINT32 RegBinding::GetTransportExt() const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
IMS_BOOL RegBinding::IsBehindNAT() const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
IMS_BOOL RegBinding::IsWithinTrustDomain() const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
void RegBinding::NotifyCallerCapabilityChanged()
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED VIRTUAL
void RegBinding::SetListener(IN IRegBindingListener *piListener)
{
    //---------------------------------------------------------------------------------------------
...
void RegBinding::CreateSIPConnectionNotifier()
{
    ...
    piSCN = pSCNMngr->CreateConnectionNotifier(
            piContact->GetContactAddress().GetScheme(),
            piContact->GetIPAddress(),
            GetPortUS(),
            GetPortUC(),
            GetPortFlowControl(),
            strParams,
...
IMS_BOOL RegBinding::IsBindingActive() const
{
    ...
    return (nState == STATE_ACTIVE)
            || (nState == STATE_ACTIVE_PENDING)
...
void RegBinding::RestoreTransportResourceForClientInitiatedConnection()
{
    ...
    if (piSCN->RestoreTransportResource(
            nTransportResource, objPeerIP, objRoute.GetPort()) != IMS_SUCCESS)
    {
        piRegEx->ConnectionNotifierError_NotifyError(
                piSCN,
                ISIPConnectionNotifier::TRANSPORT_ERROR_TCP_CLIENT,
...
PRIVATE GLOBAL
const IMS_CHAR* RegBinding::StateToString(IN IMS_SINT32 nState)
{
    //---------------------------------------------------------------------------------------------
