...
PUBLIC VIRTUAL
SIPDialogUsage::~SIPDialogUsage()
{
    IMS_TRACE_D("Destructor :: SIPDialogUsage (%s)",
            (nType == TYPE_EPHEMERAL) ? \
                "EPHEMERAL" : ((nType == TYPE_INVITE) ? "INVITE" : "SUBSCRIBE"), 0, 0);
}

PUBLIC VIRTUAL
IMS_BOOL SIPDialogUsage::InitDialogUsage(IN CONST SIPMessageInfo & /* objMInfo */)
{
    //---------------------------------------------------------------------------------------------
...
PUBLIC VIRTUAL
SIPDialogUsage* SIPDialogUsage::Clone() const
{
    //---------------------------------------------------------------------------------------------
...
PUBLIC VIRTUAL
IMS_BOOL SIPDialogUsage::CompareTo(IN CONST SIPMessageInfo & /* objMInfo */) const
{
    //---------------------------------------------------------------------------------------------
...
PUBLIC VIRTUAL
IMS_BOOL SIPDialogUsage::Equals(IN SIPDialogUsage *pDUsage) const
{
    //---------------------------------------------------------------------------------------------
...
PUBLIC VIRTUAL
AString SIPDialogUsage::ToString() const
{
    AString strValue;
...
PUBLIC VIRTUAL
IMS_SINT32 SIPDialogUsage::UpdateUsageDetails(IN CONST SIPMessageInfo &objMInfo)
{
    ...
    IMS_TRACE_D("UpdateDialogDetails() - %s : %s",
            ActionToString(nAction), TriggerToString(nTrigger), 0);

    return pDialogBase->OnUpdateDialogDetails(objMInfo, nType, nAction, nTrigger);
}

PROTECTED VIRTUAL
IMS_SINT32 SIPDialogUsage::GetActionNTrigger(IN CONST SIPMessageInfo & /* objMInfo */,
...
PROTECTED VIRTUAL
IMS_BOOL SIPDialogUsage::IsUsageTerminated(IN IMS_SINT32 /* nState */,
...
PROTECTED VIRTUAL
const IMS_CHAR* SIPDialogUsage::TriggerToString(IN IMS_SINT32 nTrigger) const
{
    //---------------------------------------------------------------------------------------------
...
PROTECTED GLOBAL
const IMS_CHAR* SIPDialogUsage::ActionToString(IN IMS_SINT32 nAction)
{
    //---------------------------------------------------------------------------------------------
