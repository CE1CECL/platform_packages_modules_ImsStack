...
public:
     ...
     */
    virtual void CoreService_PageMessageReceived(IN ICoreService *piService,
            IN IPageMessage *piMessage) = 0;
     ...
     */
    virtual void CoreService_ReferenceReceived(IN ICoreService *piService,
            IN IReference *piReference) = 0;
     ...
     */
    virtual void CoreService_ServiceClosed(IN ICoreService *piService,
            IN IReasonInfo *piReasonInfo) = 0;
     ...
     */
    virtual void CoreService_SessionInvitationReceived(IN ICoreService *piService,
            IN ISession *piSession) = 0;
     ...
     */
    virtual void CoreService_UnsolicitedNotifyReceived(IN ICoreService *piService,
            IN IMessage *piNotify) = 0;
     ...
     */
    virtual void CoreService_CapabilityQueryReceived(IN ICoreService *piService,
            IN ICapabilities *piCapabilities) = 0;
};
