...
PUBLIC
void RefreshHelper::SetPolicy(IN IMS_SINT32 nPolicy,
...
PROTECTED VIRTUAL
IMS_SINT32 RefreshHelper::GetTimerInterval() const
{
...
PRIVATE VIRTUAL
void RefreshHelper::Timer_TimerExpired(IN ITimer *piTimer)
{
    //---------------------------------------------------------------------------------------------
