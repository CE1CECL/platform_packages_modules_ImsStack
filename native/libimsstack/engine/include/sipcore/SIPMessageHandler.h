...
private:
    ...
    void NotifyPacketReceived(IN IMS_SINT32 nSlotId,
    ...
    IMS_BOOL CheckIPSecValidityForResponse(IN IMS_SINT32 nSlotId, IN SipMessage *pstMessage,
            IN CONST SIPTransportAddress &objNearEnd, IN CONST SIPTransportAddress &objFarEnd);
    IMS_BOOL IsIPSecSAMatched(IN IMS_SINT32 nSlotId,
            IN CONST SIPTransportAddress &objNearEnd, IN CONST SIPTransportAddress &objFarEnd);
    IMS_BOOL IsIPSecSAMatchedForUS(IN IMS_SINT32 nSlotId,
            IN CONST IPAddress &ojbIP, IN IMS_SINT32 nPort);
