...
public:
    ...
    IMS_RESULT RestoreTransportResource(IN IMS_SINT32 nType,
    ...
    inline IMS_BOOL IsSharedMode() const
    { return (nMode == SHARED) ? IMS_TRUE : IMS_FALSE; }
...
private:
    ...
    IMS_BOOL CreateClientInitiatedConnection(IN IMS_SINT32 nPort,
