...
public:
    ...
    SIPSocket* CreateStreamSocket(IN CONST SIPSocketAddress &objSA,
            IN CONST SIPSocketAddress &objSA_FarEnd);
    void Destroy(IN SIPSocket *&pSocket, IN ISIPSocketListener *piListener);
    void DestroyStreamSocket(IN CONST SIPSocketAddress &objSA,
            IN CONST SIPSocketAddress &objSA_FarEnd);
    SIPSocket* Open(IN CONST SIPSocketAddress &objSA);
    SIPSocket* OpenStreamSocket(IN CONST SIPSocketAddress &objSA,
            IN CONST SIPSocketAddress &objSA_FarEnd);
    ...
    // LOCAL_DNS_QUERY
    IMS_BOOL GetHostByName(IN CONST IPAddress &objLocalIP,
