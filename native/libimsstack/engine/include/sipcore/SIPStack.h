...
// Enumerations
    ...
    GLOBAL SipHeaderBase* DecodeHeader(IN IMS_SINT32 nType, IN CONST AString &strName,
    ...
    GLOBAL SipAddrSpec* GetAddrSpec(IN SipMessage *pstMessage,
            IN IMS_SINT32 nType, IN IMS_UINT32 nIndex = 0);
    ...
    GLOBAL SipHeaderBase* GetHeader(IN SipMessage *pstMessage,
            IN IMS_SINT32 nType, IN IMS_UINT32 nIndex = 0);
    ...
    GLOBAL AString GetMIMEHeader(IN SipMsgBody *pstMsgBody,
            IN IMS_SINT32 nType, IN IMS_SINT32 nIndex = 0);
    GLOBAL IMS_SINT32 GetMIMEHeaderCount(IN SipMsgBody *pstMsgBody, IN IMS_SINT32 nType);
    GLOBAL AString GetParameter(IN SipAddrSpec *pstAddrSpec,
            IN CONST AString &strName, IN IMS_UINT32 nIndex = 0);
    GLOBAL AString GetParameter(IN SipHeaderBase *pstHeader,
            IN CONST AString &strName, IN IMS_UINT32 nIndex = 0);
    ...
    GLOBAL IMS_BOOL IsUnknownHeader(IN_OUT IMS_SINT32 &nType,
            IN CONST AString &strName = AString::ConstNull());
    ...
    GLOBAL IMS_BOOL SetChallengeScheme(IN CONST AString &strScheme,
            IN_OUT SipHeaderBase *&pstHeader);
