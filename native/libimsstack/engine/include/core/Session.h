...
public:
    ...
    // }
    inline VirtualSession* GetVirtualEarlySession() const
    { return pVirtualEarlySession.Get(); }
...
protected:
    ...
    virtual void RetryTaskHelper_OnCompleted(IN RetryTaskHelper *pTaskHelper, IN RetryCmd *pCmd,
            IN IMS_SINT32 nCode = 0);
#endif
