...
public:
    inline VirtualSession* GetSession() const
    { return pSession.Get(); }
    inline void UpdateSession(IN VirtualSession* pSession_)
    { pSession = pSession_; }
...
private:
    ...
    // }
    // EARLY_SESSION_MODEL {
    inline virtual ISession* GetOwnerSession() const
    { return piOwnerSession; }
    inline virtual ISession* GetVirtualSession() const
    { return IMS_NULL; }
    // }
