...
PUBLIC GLOBAL
ImsAppId ImsServiceConfig::GetAppId(IN ImsServiceId eServiceId)
{
    switch (eServiceId)
    {
...
PUBLIC GLOBAL
AString ImsServiceConfig::GetAppName(IN ImsAppId eAppId)
{
    switch (eAppId)
    {
    case ImsAppId::MTC:
...
PUBLIC GLOBAL
AString ImsServiceConfig::GetServiceName(IN ImsServiceId eServiceId)
{
    switch (eServiceId)
    {
...
PUBLIC GLOBAL
const IMS_CHAR* ImsServiceConfig::GetAppNameC(IN ImsAppId eAppId)
{
    switch (eAppId)
    {
    case ImsAppId::MTC:
...
PUBLIC GLOBAL
const IMS_CHAR* ImsServiceConfig::GetServiceNameC(IN ImsServiceId eServiceId)
{
    switch (eServiceId)
    {
    case ImsServiceId::MTC:
...
PUBLIC GLOBAL
ImsServiceProfile ImsServiceConfig::GetServiceProfile()
{
...
PUBLIC GLOBAL
ImsServiceProfile ImsServiceConfig::GetEmergencyServiceProfile()
{
    ImsServiceProfile objProfile = { 0, IMS_NULL };

    objProfile.nCount = sizeof(s_objEmergencyServiceIdentifiers)
            / sizeof(s_objEmergencyServiceIdentifiers[0]);
...
PUBLIC GLOBAL
IMSList<ImsServiceName> ImsServiceConfig::GetServiceNames(IN const ImsServiceProfile& objProfile)
{
