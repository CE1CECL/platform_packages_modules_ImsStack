...
public:
    ...
    {
        return m_objPcscfDiscoveryMethods.IsEmpty()
    ...
    inline const AString& GetConfName() const
    { return m_strConfName; }
    inline const AString& GetId() const
    { return m_strId; }
...
private:
    ...
    inline void ResetIsimRecord(IN IMS_SINT32 nRecord)
    { m_nIsimRecords &= (~nRecord); }
    inline void SetIsimRecord(IN IMS_SINT32 nRecord)
    { m_nIsimRecords |= nRecord; }
