...
public:
     ...
     *         #SIP_FEATURE_CAPS_LOCAL_TIME_ZONE_REQUIRED_IN_PANI_HEADER\n
     ...
     *         #SIP_FEATURE_CAPS_COUNTRY_INFO_IN_PANI_HEADER\n
...
public:
    ...
    enum
    {
        ...
        SIP_FEATURE_CAPS_INVALID_MAC_ADDRESS_REQUIRED_IN_PANI_HEADER = 1 << 13,
        SIP_FEATURE_CAPS_LOCAL_TIME_ZONE_REQUIRED_IN_PANI_HEADER = 1 << 14,
        ...
        SIP_FEATURE_CAPS_COUNTRY_INFO_IN_PANI_HEADER = 1 << 23,
