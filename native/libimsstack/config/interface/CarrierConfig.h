...
public:
    ...
    public:
        ...
        static const IMS_CHAR KEY_EMC_CALL_BASED_ON_P_ASSOCIATED_URI_OF_NORMAL_REG_BOOL[];
        ...
        static const IMS_CHAR KEY_EMC_PREFERRED_IPTYPE_INT[];
        ...
        static const IMS_CHAR KEY_ROAMING_PREFERRED_EMC_REG_INT[];
        ...
        static const IMS_CHAR KEY_REREG_ERR_CODE_FOR_PDN_REACTIVATION_AFTER_CALL_END_INT_ARRAY[];
