...
public:
    ...
    public:
        ...
        static const IMS_CHAR KEY_REGISTRATION_EVENT_FOR_CAT_REQUIRED_BOOL[];
        ...
        static const IMS_CHAR KEY_REGISTRATION_ACTUAL_WAIT_TIME_POLICY_INT[];
        // Bundle {
        static const IMS_CHAR KEY_NOTIFY_TERMINATED_FOR_REG_EVENT_WITH_INITIAL_REGISTRATION_BUNDLE[];
        static const IMS_CHAR KEY_WAIT_TIME_FOR_INITIAL_REGISTRATION_ON_TERMINATED_STATE_OF_REG_EVENT_INT[];
        static const IMS_CHAR KEY_EVENT_FOR_INITIAL_REGISTRATION_ON_TERMINATED_STATE_OF_REG_EVENT_INT_ARRAY[];
        static const IMS_CHAR KEY_EVENT_TO_FOLLOW_WAIT_TIME_FOR_INITIAL_REGISTRATION_ON_TERMINATED_STATE_OF_REG_EVENT_INT_ARRAY[];
        // }
        // Bundle {
        static const IMS_CHAR KEY_REGISTRATION_RETRY_INTERVAL_BUNDLE[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_RANDOM_UPPER_VALUE_SEC_INT_ARRAY[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_INTERVAL_SEC_INT_ARRAY[];
        static const IMS_CHAR KEY_USE_REGISTRATION_RETRY_INTERVAL_FOR_SUBSCRIPTION_RETRY_BOOL[];
        // }
        // Bundle {
        static const IMS_CHAR KEY_REGISTRATION_PERMANENT_ERROR_CODE_BUNDLE[];
        static const IMS_CHAR KEY_REGISTRATION_PERMANENT_ERROR_CODE_INT_ARRAY[];
        static const IMS_CHAR KEY_REGISTRATION_PERMANENT_ERROR_MAX_COUNT_INT_ARRAY[];
        // }
        ...
        enum
        {
            REGISTRATION_OOS_POLICY_DEFAULT = 0,
            REGISTRATION_OOS_POLICY_DESTROY = 1
        };
    ...
    public:
        ...
        static const IMS_CHAR KEY_EMERGENCY_RETRY_WITHOUT_CHECKING_380_CONTENT_FOR_NON_UE_DETECTABLE_EMERGENCY_CALL_BOOL[];
    ...
    public:
        ...
        static const IMS_CHAR KEY_TEXT_PORT_RTP_INT_ARRAY[];
    ...
    public:
        ...
        static const IMS_CHAR KEY_SESSION_REFRESH_TRIGGER_INTERVAL_MILLIS_INT[];
        ...
        static const IMS_CHAR KEY_SILENT_REDIAL_INTERVAL_INT[];
        ...
        static const IMS_CHAR KEY_VALIDATE_VERSTAT_FEATURE_IN_REGISTRATION_TO_CHECK_NETWORK_CAPABILITY_BOOL[];
        ...
        static const IMS_CHAR KEY_CALL_TERMINATE_REASON_HEADER_USER_ENDS_AND_SIP_RESPONSE_TIMEOUT_STRING[];
        static const IMS_CHAR KEY_CALL_TERMINATE_REASON_HEADER_CALL_SETUP_TIMEOUT_STRING[];
        static const IMS_CHAR KEY_CALL_TERMINATE_REASON_HEADER_REDIRECTION_FAILURE_STRING[];
        ...
        static const IMS_CHAR KEY_CALL_TERMINATE_REASON_HEADER_INTERNAL_ERROR_STRING[];
        ...
        static const IMS_CHAR KEY_EVS_SUPPORT_BOOL[];
        static const IMS_CHAR KEY_AUDIO_PORT_RTP_INT_ARRAY[];
    ...
    public:
        ...
        static const IMS_CHAR KEY_SUPPORT_VIDEO_TEXT_FEATURE_IN_CONTACT_HEADER_SIMULTANEOUSLY_BOOL[];
        // Media
        static const IMS_CHAR KEY_HEVC_SUPPORT_BOOL[];
        static const IMS_CHAR KEY_VIDEO_SDP_ANSWER_FULL_CAPABILITY_BOOL[];
        static const IMS_CHAR KEY_VIDEO_PORT_RTP_INT_ARRAY[];
        static const IMS_CHAR KEY_VIDEO_RTCP_INTERVAL_INT_ARRAY[];
        static const IMS_CHAR KEY_VIDEO_FRAME_RATE_INT[];
        static const IMS_CHAR KEY_VIDEO_BITRATE_ADAPT_ENABLE_BOOL[];
        static const IMS_CHAR KEY_VIDEO_SEND_PERIODIC_SPS_PPS_INT[];
        static const IMS_CHAR KEY_VIDEO_AVPF_ENABLE_BOOL[];
        static const IMS_CHAR KEY_VIDEO_SDP_OFFER_CAPNEGO_FOR_AVPF_INT[];
        static const IMS_CHAR KEY_VIDEO_AVPF_TRR_BOOL[];
        static const IMS_CHAR KEY_VIDEO_AVPF_NACK_BOOL[];
        static const IMS_CHAR KEY_VIDEO_AVPF_TMMBR_BOOL[];
        static const IMS_CHAR KEY_VIDEO_AVPF_PLI_BOOL[];
        static const IMS_CHAR KEY_VIDEO_AVPF_FIR_BOOL[];
        static const IMS_CHAR KEY_VIDEO_AVPF_TMMBR_DOWN_INTERVAL_SEC_INT[];
        static const IMS_CHAR KEY_VIDEO_AVPF_TMMBR_UP_INTERVAL_SEC_INT[];
        static const IMS_CHAR KEY_VIDEO_AVPF_TMMBR_LOSS_THRESHOLD_RATIO_INT[];
        static const IMS_CHAR KEY_VIDEO_AVPF_TMMBR_MIN_BITRATE_KBPS_INT[];
        static const IMS_CHAR KEY_VIDEO_AVPF_TMMBR_BITRATE_LEVEL_INT[];
        static const IMS_CHAR KEY_VIDEO_AVPF_TMMBR_UP_LEVEL_INT[];
    ...
    public:
        ...
        static const IMS_CHAR KEY_SESSION_TIMER_UPDATE_REQUIRED_IN_SESSION_UPDATE_BY_REINVITE_BOOL[];
        static const IMS_CHAR KEY_ALLOW_SIP_INSTANCE_PARAMETER_IN_CONTACT_FOR_NON_REGISTER_REQUEST_BOOL[];
        ...
        // Aos
        static const IMS_CHAR KEY_USE_SECURITY_SERVER_PORT_IN_REG_CONTACT_OF_INITIAL_REGISTRATION_BOOL[];
        static const IMS_CHAR KEY_USE_SECURITY_SERVER_PORT_IN_INITIAL_REGISTRATION_BOOL[];
        static const IMS_CHAR KEY_REMOVE_OLD_SA_ON_ESTABLISHING_SA_BOOL[];
        static const IMS_CHAR KEY_USE_G_GSMA_RCS_TELEPHONY_FEATURE_TAG_TO_SPECIFY_AVAILABLE_VOICE_CALL_TYPE_BOOL[];
        static const IMS_CHAR KEY_PCSCF_DISCOVERY_METHOD_ROAMING_INT_ARRAY[];
        static const IMS_CHAR KEY_HOLD_REGISTRATION_WHEN_IPCAN_CHANGED_WITH_IMS_ACTIVE_CALL_BOOL[];
        static const IMS_CHAR KEY_SUPPORT_VERSTAT_FOR_REGISTRATION_BOOL[];
        static const IMS_CHAR KEY_NO_INITIAL_REGISTRATION_ON_PCSCF_CHANGE_BOOL[];
        static const IMS_CHAR KEY_EMERGENCY_CALL_BASED_ON_P_ASSOCIATED_URI_OF_NORMAL_REGISTRATION_BOOL[];
        static const IMS_CHAR KEY_SIP_OVER_IPSEC_ENABLED_IN_ROAMING_BOOL[];
        static const IMS_CHAR KEY_REGISTRATION_CONTACT_VALIDATION_BOOL[];
        ...
        static const IMS_CHAR KEY_SPECIFIC_REGISTRATION_ERROR_POLICY_INT[];
        static const IMS_CHAR KEY_SPECIFIC_REGISTRATION_ERROR_MAX_COUNT_INT[];
        static const IMS_CHAR KEY_SPECIFIC_REGISTRATION_ERROR_MIN_COUNT_INT[];
        static const IMS_CHAR KEY_SPECIFIC_REGISTRATION_ERROR_RETRY_COUNT_SHARED_FOR_REGISTRATION_AND_REG_EVENT_BOOL[];
        static const IMS_CHAR KEY_SPECIFIC_REGISTRATION_ERROR_NUMBER_MULTIPLIED_BY_PCSCF_NUMBER_INT_ARRAY[];
        static const IMS_CHAR KEY_SPECIFIC_REGISTRATION_ERROR_CODE_INT_ARRAY[];
        static const IMS_CHAR KEY_SPECIFIC_REREGISTRATION_ERROR_CODE_INT_ARRAY[];
        static const IMS_CHAR KEY_SPECIFIC_REGISTRATION_ERROR_WAIT_TIME_SEC_INT_ARRAY[];
        static const IMS_CHAR KEY_SPECIFIC_REREGISTRATION_FAILURE_WITH_ERROR_CODE_IN_ROAMING_BOOL[];
        // }
        // Bundle {
        static const IMS_CHAR KEY_REGISTRATION_RETRY_BUNDLE[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_MIN_COUNT_INT[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_SIP_305_CODE_POLICY_INT[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_ERROR_CODE_WITHOUT_IPSEC_INT_ARRAY[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_TIMER_F_POLICY_INT[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_ERROR_CODE_WITH_DIFFERENT_PCSCF_INT_ARRAY[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_WITH_IP_VERSION_FALLBACK_BOOL[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_DEFAULT_POLICY_INT[];
        static const IMS_CHAR KEY_REGISTRATION_RETRY_SIP_503_CODE_POLICY_INT[];
        // }
        // Bundle {
        static const IMS_CHAR KEY_REREGISTRATION_RETRY_BUNDLE[];
        static const IMS_CHAR KEY_REREGISTRATION_RETRY_ERROR_CODE_WITH_INITIAL_REGISTRATION_INT_ARRAY[];
        static const IMS_CHAR KEY_REREGISTRATION_RETRY_EXPIRE_TIME_CHECKED_BOOL[];
        static const IMS_CHAR KEY_REREGISTRATION_RETRY_MAX_COUNT_KEPT_REGISTRATION_INT[];
        static const IMS_CHAR KEY_REREGISTRATION_RETRY_ERROR_CODE_WITH_INITIAL_REGISTRATION_WITH_SAME_PCSCF_INT_ARRAY[];
        static const IMS_CHAR KEY_REREGISTRATION_RETRY_SIP_305_CODE_POLICY_INT[];
        // }
        // Bundle {
        ...
        static const IMS_CHAR KEY_REREGISTRATION_ERROR_CAUSE_WITH_PDN_REACTIVATION_AFTER_CALL_END_INT_ARRAY[];
        // }
        static const IMS_CHAR KEY_VOWIFI_SUBSCRIPTION_ERROR_CODE_WITH_INITIAL_REGISTRATION_INT_ARRAY[];
        // Bundle {
        static const IMS_CHAR KEY_SUBSCRIPTION_ERROR_CODE_FOR_REG_EVENT_WITH_INITIAL_REGISTRATION_BUNDLE[];
        static const IMS_CHAR KEY_SUBSCRIPTION_ERROR_RETRY_MAX_COUNT_FOR_REG_EVENT_WITH_INITIAL_REGISTRATION_INT[];
        static const IMS_CHAR KEY_SUBSCRIPTION_ERROR_CODE_FOR_REG_EVENT_WITH_INITIAL_REGISTRATION_INT_ARRAY[];
        // }
        // Bundle {
        static const IMS_CHAR KEY_SUBSCRIPTION_TERMINATED_ERROR_CODE_FOR_REG_EVENT_BUNDLE[];
        static const IMS_CHAR KEY_SUBSCRIPTION_TERMINATED_ERROR_CODE_FOR_REG_EVENT_RETRY_MAX_COUNT_INT[];
        static const IMS_CHAR KEY_SUBSCRIPTION_TERMINATED_ERROR_CODE_FOR_REG_EVENT_INT_ARRAY[];
        // }
        static const IMS_CHAR KEY_SUBSCRIPTION_ERROR_CODE_FOR_STOPPING_BY_EXPIRATION_TIME_INT_ARRAY[];
        static const IMS_CHAR KEY_SUBSCRIPTION_ERROR_CODE_FOR_REG_EVENT_WITH_INITIAL_REGISTRATION_WITH_NEXT_PCSCF_INT_ARRAY[];
        // Bundle {
        static const IMS_CHAR KEY_REGISTRATION_ERROR_CODE_WITH_RETRY_AFTER_TIME_BUNDLE[];
        ...
        static const IMS_CHAR KEY_SMS_OVER_IMS_AVAILABLE_IN_NO_VOPS_BOOL[];
        static const IMS_CHAR KEY_IMS_DEREGISTER_ON_3G_NETWORKS_BOOL[];
        static const IMS_CHAR KEY_REQUIRED_EMERGENCY_REGISTRATION_IN_ROAMING_BOOL[];
        static const IMS_CHAR KEY_CLEAR_PERMANENT_PDN_FAILURE_INT_ARRAY[];
        static const IMS_CHAR KEY_USE_WFC_COUNTRY_CODE_AVAILABILITY_CHECK_BOOL[];
        static const IMS_CHAR KEY_REQUIRED_VOLTE_BLOCK_BY_SETTING_BOOL[];
        static const IMS_CHAR KEY_REQUIRED_VOLTE_BLOCK_BY_AIRPLANE_MODE_BOOL[];
        ...
        static const IMS_CHAR KEY_EMERGENCY_PREFERRED_IPTYPE_INT[];
        ...
        static const IMS_CHAR KEY_SUPPORT_REGISTRATION_RECOVERY_FOR_FAILURE_OF_SESSION_REFRESH_BOOL[];
        static const IMS_CHAR KEY_POLICY_FOR_CALL_MAINTAINING_ON_REGISTRATION_SUSPENDED_INT_ARRAY[];
        static const IMS_CHAR KEY_POLICY_FOR_REQUIRING_EMERGENCY_CALL_WHEN_VIDEO_EMERGENCY_CALL_FAILED_INT_ARRAY[];
        ...
        static const IMS_CHAR KEY_REGISTRATION_DISCONNECT_REASON_TO_TERMINATE_ONGOING_CALL_INT_ARRAY[];
        ...
        static const IMS_CHAR KEY_USE_CARRIER_SPECIFIC_REJECT_PHRASE_FOR_INCOMING_CALL_DURING_NO_REGISTRATION_BOOL[];
        static const IMS_CHAR KEY_ENABLE_REGISTRATION_RECOVERY_WHEN_CALL_REJECTED_BY_SERVER_ERROR_BOOL[];
        ...
        static const IMS_CHAR KEY_SET_VIDEO_TEXT_FEATURE_EXCLUSIVELY_IN_CONTACT_HEADER_BY_SESSION_TYPE_BOOL[];
        ...
        static const IMS_CHAR KEY_ENABLE_VOICEMAIL_SERVICE_BY_PAID_HEADER_BOOL[];
        static const IMS_CHAR KEY_IGNORE_P_EARLY_MEDIA_HEADER_BOOL[];
        ...
        static const IMS_CHAR KEY_VIDEO_DROP_P_FRAME_BOOL[];
        static const IMS_CHAR KEY_AUDIO_SDP_ANSWER_FULL_CAPABILITY_BOOL[];
        static const IMS_CHAR KEY_AUDIO_RTP_DSCP_INT[];
        static const IMS_CHAR KEY_AUDIO_TELEPHONE_EVENT_DURATION_INT_ARRAY[];
        static const IMS_CHAR KEY_VIDEO_CODEC_H264_SPROP_PARAMETER_SETS_BOOL[];
        static const IMS_CHAR KEY_VIDEO_CODEC_HEVC_SPROP_PARAMETER_SETS_BOOL[];
        static const IMS_CHAR KEY_VIDEO_CODEC_H264_MAX_MBPS_INT[];
        static const IMS_CHAR KEY_VIDEO_CODEC_H264_MAX_FS_INT[];
        static const IMS_CHAR KEY_VIDEO_CODEC_H264_MAX_CPB_INT[];
        static const IMS_CHAR KEY_VIDEO_CODEC_H264_MAX_DPB_INT[];
        static const IMS_CHAR KEY_VIDEO_CODEC_H264_MAX_BR_INT[];
        static const IMS_CHAR KEY_VIDEO_CODEC_HEVC_MAX_MBPS_INT[];
        static const IMS_CHAR KEY_VIDEO_CODEC_HEVC_MAX_FS_INT[];
        static const IMS_CHAR KEY_VIDEO_CODEC_HEVC_MAX_CPB_INT[];
        static const IMS_CHAR KEY_VIDEO_CODEC_HEVC_MAX_DPB_INT[];
