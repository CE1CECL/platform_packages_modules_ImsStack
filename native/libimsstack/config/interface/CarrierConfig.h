...
public:
    ...
    public:
        ...
        static const IMS_CHAR KEY_SILENT_RETRY_EMERGENCY_CALL_WITH_DELAY_OF_RETRY_AFTER_BOOL[];
        ...
        static const IMS_CHAR KEY_SILENT_REDIAL_WITH_ANONYMOUS_BY_NETWORK_REJECTION_BOOL[];
