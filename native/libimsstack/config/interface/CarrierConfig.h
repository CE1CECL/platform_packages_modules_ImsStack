...
public:
    ...
    public:
        ...
        static const IMS_CHAR KEY_REG_RETRY_IP_VER_FALLBACK_BOOL[];
        ...
        static const IMS_CHAR KEY_REREG_RETRY_EXPIRE_TIME_CHECKED_BOOL[];
        ...
        static const IMS_CHAR KEY_REREG_RETRY_MAX_CNT_TO_KEEP_REG_INT[];
        ...
        static const IMS_CHAR KEY_REG_RETRY_ERR_CODE_WITH_DIFF_PCSCF_INT_ARRAY[];
        ...
        static const IMS_CHAR KEY_REREG_RETRY_ERR_CODE_FOR_INIT_REG_INT_ARRAY[];
        ...
        static const IMS_CHAR KEY_EXTRA_REG_ERR_MIN_CNT_INT[];
        ...
        static const IMS_CHAR KEY_SUB_ERR_CODE_FOR_TERMINATED_WITH_RETRY_MAX_COUNT_INT[];
