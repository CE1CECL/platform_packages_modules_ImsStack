...
public:
    ...
    public:
        ...
        static const IMS_CHAR KEY_DESTROY_UNSECURE_TCP_SOCKET_ON_ACCOMPLISHING_REGISTRATION_BOOL[];
        static const IMS_CHAR
        ...
        static const IMS_CHAR KEY_REREG_ERROR_CODES_WITH_INIT_REG_WITH_AVAILABLE_PCSCF_INT_ARRAY[];
        static const IMS_CHAR KEY_REREG_ERROR_CODES_WITH_IMS_PDN_REACTIVATION_INT_ARRAY[];
        static const IMS_CHAR KEY_REQUIRE_REG_AFTER_IMS_CALL_END_ON_REG_HELD_BOOL[];
        // Bundle {
        ...
        static const IMS_CHAR KEY_EVT_FOR_INIT_REG_ON_TERMINATED_STATE_OF_REG_EVENT_INT_ARRAY[];
        static const IMS_CHAR
        ...
        static const IMS_CHAR KEY_SEND_180_FOR_INITIAL_INVITE_BOOL[];
        // Media
        ...
        static const IMS_CHAR KEY_ASSET_AMRWB_PAYLOAD_TYPE_INT_ARRAY[];
        static const IMS_CHAR KEY_ASSET_AMRNB_PAYLOAD_TYPE_INT_ARRAY[];
        static const IMS_CHAR KEY_ASSET_DTMFWB_PAYLOAD_TYPE_INT_ARRAY[];
        static const IMS_CHAR KEY_ASSET_DTMFNB_PAYLOAD_TYPE_INT_ARRAY[];

        static const IMS_CHAR KEY_ASSET_AMRWB_CODEC_ATTRIBUTE_PAYLOAD_FORMAT_INT_ARRAY[];
        static const IMS_CHAR KEY_ASSET_AMRNB_CODEC_ATTRIBUTE_PAYLOAD_FORMAT_INT_ARRAY[];

        static const IMS_CHAR KEY_ASSET_AMR_AMRWB_CODEC_ATTRIBUTE_MODESET_INT_ARRAY[];
        static const IMS_CHAR KEY_ASSET_AMR_AMRNB_CODEC_ATTRIBUTE_MODESET_INT_ARRAY[];

        static const IMS_CHAR KEY_ASSET_EVS_CODEC_ATTRIBUTE_CHANNELS_INT[];
        static const IMS_CHAR KEY_ASSET_EVS_CODEC_ATTRIBUTE_HF_ONLY_INT[];
        static const IMS_CHAR KEY_ASSET_EVS_CODEC_ATTRIBUTE_MODE_SWITCH_INT[];
        static const IMS_CHAR KEY_ASSET_EVS_CODEC_ATTRIBUTE_BANDWIDTH_INT[];
        static const IMS_CHAR KEY_ASSET_EVS_CODEC_ATTRIBUTE_CMR_INT[];
        static const IMS_CHAR KEY_ASSET_EVS_CODEC_ATTRIBUTE_CH_AW_RECV_INT[];
        static const IMS_CHAR KEY_ASSET_AMR_CODEC_ATTRIBUTE_PAYLOAD_FORMAT_INT[];
        static const IMS_CHAR KEY_ASSET_CODEC_ATTRIBUTE_MODE_CHANGE_PERIOD_INT[];
        static const IMS_CHAR KEY_ASSET_CODEC_ATTRIBUTE_MODE_CHANGE_CAPABILITY_INT[];
        static const IMS_CHAR KEY_ASSET_CODEC_ATTRIBUTE_MODE_CHANGE_NEIGHBOR_INT[];
        static const IMS_CHAR KEY_ASSET_EVS_CODEC_ATTRIBUTE_DTX_BOOL[];
        static const IMS_CHAR KEY_ASSET_EVS_CODEC_ATTRIBUTE_DTX_RECV_BOOL[];
