...
PUBLIC GLOBAL
const IMS_CHAR ConfigMtc::APP_NAME[] = CONFIG_APP_NAME;
PUBLIC GLOBAL
const IMS_CHAR ConfigMtc::SERVICE_NAME[] = CONFIG_SERVICE_NAME;
PUBLIC GLOBAL
const IMS_CHAR ConfigMtc::EMERGENCY_SERVICE_NAME[] = CONFIG_EMERGENCY_SERVICE_NAME;

PUBLIC GLOBAL
const IMS_CHAR ConfigMtc::APP_CONFIG[] =
{
    "[Uniqueness]\n"
    "Stream=1\n"
    "Framed=0\n"
