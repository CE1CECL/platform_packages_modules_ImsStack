...
PUBLIC GLOBAL
const IMS_CHAR ConfigMedia::MEDIA_NAME[] = "media";
PUBLIC GLOBAL
const IMS_CHAR ConfigMedia::MEDIA_CAPABILITIES_NAME[] = CONFIG_MEDIA_CAPABILITIES;

PUBLIC GLOBAL
const IMS_CHAR ConfigMedia::MEDIA_CONFIG[] =
{
    "[profiles]\n"
...
PUBLIC GLOBAL
const IMS_CHAR ConfigMedia::MEDIA_CAPABILITIES_CONFIG[] =
{
    "[" CONFIG_CAPABILITIES "]\n"
