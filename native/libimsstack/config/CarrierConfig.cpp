...
const IMS_CHAR CarrierConfig::Ims::KEY_IGNORE_UDP_TRANSPORT_PARAMETER_FOR_OUTGOING_REQUEST_BOOL[] =
        KEY_IMS_PREFIX "ignore_udp_transport_parameter_for_outgoing_request_bool";
...
const IMS_CHAR CarrierConfig::Ims::KEY_ALLOW_NO_POSITION_IN_GEOLOCATION_PIDF_BOOL[] =
        KEY_IMS_PREFIX "allow_no_position_in_geolocation_pidf_bool";
...
const IMS_CHAR CarrierConfig::Ims::KEY_AUTH_FAILURE_RETRY_MAX_CNT_INT[] =
        KEY_IMS_PREFIX "auth_failure_retry_max_cnt_int";
...
const IMS_CHAR CarrierConfig::Ims::KEY_REG_TEMP_PLMN_BLOCK_RATS_ON_ALL_PCSCFS_FAIL_INT_ARRAY[] =
        KEY_IMS_PREFIX "reg_temp_plmn_block_rats_on_all_pcscfs_fail_int_array";
...
const IMS_CHAR CarrierConfig::ImsEmergency::
        KEY_PLMNS_RELEASE_EPDN_UPON_ECALL_END_IN_FAKE_MODE_STRING_ARRAY[] = KEY_IMS_EMERGENCY_PREFIX
        "plmns_release_epdn_upon_ecall_end_in_fake_mode_string_array";
...
const IMS_CHAR CarrierConfig::ImsVoice::KEY_FORCE_183_BEFORE_ALERTING_ON_NON_100REL_INVITE_BOOL[] =
        KEY_IMS_VOICE_PREFIX "force_183_before_alerting_on_non_100rel_invite_bool";
...
const IMS_CHAR CarrierConfig::ImsVoice::KEY_RELEASE_CALL_ON_DEDICATED_BEARER_WAIT_TIMEOUT_BOOL[] =
        KEY_IMS_VOICE_PREFIX "release_call_on_dedicated_bearer_wait_timeout_bool";
...
const IMS_CHAR
        CarrierConfig::ImsVoice::KEY_WAIT_QOS_FOR_INCOMING_INVITE_WITHOUT_PRECONDITION_BOOL[] =
                KEY_IMS_VOICE_PREFIX "wait_qos_for_incoming_invite_without_precondition_bool";
...
const IMS_CHAR CarrierConfig::ImsEmergency::KEY_RELEASE_EMERGENCY_PDN_ON_FAILURE_AFTER_100_BOOL[] =
        KEY_IMS_EMERGENCY_PREFIX "release_emergency_pdn_on_failure_after_100_bool";
const IMS_CHAR CarrierConfig::ImsEmergency::
...
const IMS_CHAR CarrierConfig::ImsVoice::KEY_MEDIA_ADD_C_LINE_FOR_EACH_MEDIA_BOOL[] =
        KEY_IMS_VOICE_PREFIX "media_add_c_line_for_each_media_bool";
