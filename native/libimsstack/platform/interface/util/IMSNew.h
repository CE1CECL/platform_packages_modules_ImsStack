...
GLOBAL void* operator new[](IN IMS_SIZE_T nSize, IN CONST IMS_CHAR *pszFile, IN IMS_UINT16 nLine);
GLOBAL void operator delete(IN void *pMem,
        IN CONST IMS_CHAR *pszFile, IN IMS_UINT16 nLine) IMS_NO_EXCEPTION;
GLOBAL void operator delete[](IN void *pMem,
        IN CONST IMS_CHAR *pszFile, IN IMS_UINT16 nLine) IMS_NO_EXCEPTION;
...
GLOBAL IMS_SINT32 IMS_MEM_Memcmp(IN CONST void *pvMem1, IN CONST void *pvMem2,
        IN IMS_SIZE_T nCount);
