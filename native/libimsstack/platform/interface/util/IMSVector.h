...
public:
    ...
    inline T GetValueAt(IN IMS_UINT32 nIndex) const
    ...
    // Remove one element
    inline IMS_SLONG RemoveAt(IN IMS_UINT32 nIndex)
...
PUBLIC
template <class T> inline
IMSVector<T>::IMSVector(IN CONST IMSVector<T> &objRHS)
...
PUBLIC
template <class T> inline
IMSVector<T>& IMSVector<T>::operator=(IN CONST IMSVector<T> &objRHS)
{
    if (this != &objRHS)
    {
        mVector = objRHS.mVector;
...
PUBLIC
template <class T> inline
const T* IMSVector<T>::GetArrayConst() const
{
    return mVector.data();
}
...
PUBLIC
template <class T> inline
const T& IMSVector<T>::operator[](IN IMS_UINT32 nIndex) const
{
...
PUBLIC
template <class T> inline
const T& IMSVector<T>::GetAt(IN IMS_UINT32 nIndex) const
{
    return mVector.at(nIndex);
}
...
PUBLIC
template <class T> inline
const T& IMSVector<T>::GetAtMirror(IN IMS_SLONG nIndex) const
{
...
PUBLIC
template <class T> inline
T& IMSVector<T>::GetAt(IN IMS_UINT32 nIndex)
{
    return mVector.at(nIndex);
}
...
PUBLIC
template <class T> inline
IMS_SLONG IMSVector<T>::InsertVectorAt(IN CONST IMSVector<T> &objVector, IN IMS_UINT32 nIndex)
{
...
PUBLIC
template <class T> inline
IMS_SLONG IMSVector<T>::AppendVector(IN CONST IMSVector<T> &objVector)
{
...
PUBLIC
template <class T> inline
void IMSVector<T>::Push(IN CONST T &element)
{
...
PUBLIC
template <class T> inline
IMS_SLONG IMSVector<T>::Add(IN CONST T &element)
{
    mVector.push_back(element);
    return GetSize() - 1;
}
...
PUBLIC
template <class T> inline
IMS_SLONG IMSVector<T>::InsertAt(IN IMS_UINT32 nIndex, IN IMS_UINT32 nCount_ /* = 1 */)
{
    const auto& it = mVector.begin();
...
PUBLIC
template <class T> inline
IMS_SLONG IMSVector<T>::InsertAt(IN CONST T &element, IN IMS_UINT32 nIndex, IN IMS_UINT32 nCount_ /* = 1 */)
{
    const auto& it = mVector.begin();
...
PUBLIC
template <class T> inline
IMS_SLONG IMSVector<T>::ReplaceAt(IN IMS_UINT32 nIndex)
{
    if (nIndex >= GetSize())
    {
        return (-1);
...
PUBLIC
template <class T> inline
IMS_SLONG IMSVector<T>::ReplaceAt(IN CONST T &element, IN IMS_UINT32 nIndex)
{
    if (nIndex >= GetSize())
    {
        return (-1);
...
PUBLIC
template <class T> inline
IMS_SLONG IMSVector<T>::RemoveElementsAt(IN IMS_UINT32 nIndex, IN IMS_UINT32 nCount_ /* = 1 */)
{
