...
LOCAL void imsMD5_CopyMemory(OUT IMS_UCHAR *pucDest,
        IN CONST IMS_UCHAR *pucSrc, IN IMS_UINT32 nSrcLen);
LOCAL void imsMD5_Decode(IN CONST IMS_UCHAR *pucSrc, IN IMS_UINT32 nSrcLen,
        OUT IMS_UINT32 *pnDest);
LOCAL void imsMD5_Encode(IN CONST IMS_UINT32 *pnSrc,
...
*/
GLOBAL void IMSMD5_Update(IN CONST IMS_UCHAR *pucSrc, IN IMS_UINT32 nSrcLen,
        IN_OUT MD5Context *pstContext)
{
