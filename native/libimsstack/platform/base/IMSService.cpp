...
PROTECTED VIRTUAL
IMS_BOOL IMSService::OnPreprocess(IN IMSMSG & /* objMSG */)
{
    return IMS_FALSE;
}

PROTECTED VIRTUAL
IMS_BOOL IMSService::OnMessage(IN IMSMSG & /* objMSG */)
{
    return IMS_FALSE;
}

PROTECTED VIRTUAL
IMS_BOOL IMSService::OnPostprocess(IN IMSMSG & /* objMSG */)
{
    return IMS_FALSE;
}

PROTECTED VIRTUAL
IIMSActivityControl* IMSService::GetController()
{
    return IMS_NULL;
}
...
PRIVATE VIRTUAL
IMS_BOOL IMSService::DispatchMessage(IN IMSMSG &objMSG)
{
