...
PROTECTED VIRTUAL
IMS_BOOL BaseThread::Runnable_Run(IN IMSMSG &objMSG)
{
    ...
    {
        IMS_TRACE_D("Message(%d) is not for thread(%s)",
                objMSG.GetName(), GetName().GetStr(), 0);
        return IMS_FALSE;
    }
...
PROTECTED VIRTUAL
IMS_BOOL BaseThread::Initialize()
{
    // no-op
    return IMS_TRUE;
}
...
PROTECTED VIRTUAL
void BaseThread::Uninitialize()
{
    // no-op
}

PROTECTED VIRTUAL
IMS_BOOL BaseThread::OnStart(IN IMSMSG & /* objMSG */)
{
    // no-op
    return IMS_TRUE;
}
...
PROTECTED VIRTUAL
IMS_BOOL BaseThread::OnTerminate(IN IMSMSG & /* objMSG */)
{
    // no-op
    return IMS_TRUE;
}
...
PROTECTED VIRTUAL
IMS_BOOL BaseThread::OnMessage(IN IMSMSG & /* objMSG */)
{
    // no-op
    return IMS_FALSE;
}
