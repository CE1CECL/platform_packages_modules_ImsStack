 ...
 */
#ifndef OS_NETWORK_CONNECTION_H_
#define OS_NETWORK_CONNECTION_H_
...
private:
    ...
    virtual void System_NotifyEvent(IN IMS_UINT32 nEvent, IN IMS_UINTP nWParam,
    ...
    void NotifyIpcanCatChanged();
    void NotifyPcscfChanged();
...
private:
    IMS_SINT32 m_nIpcanCategory;

    IMS_UINT32 m_nState;
    IMS_SINT32 m_nDataState;

    NetworkPolicy* m_pPolicy;
    // APN when data connection is connected
    AString m_strApn;
