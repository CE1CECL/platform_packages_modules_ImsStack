...
TEST_F(SipInfoBaseTest, EncodeHdrAndDecodeHdr)
{
    ...
    EXPECT_EQ(SIP_TRUE, pHeader->DecodeHdr((char*)"<http://www.example.com/audio/xyz.wav>", 38));
    ...
    EXPECT_EQ(SIP_TRUE,
            pHeader->DecodeHdr((char*)"<http://www.example.com/audio/xyz.wav>;appearance=2", 51));
