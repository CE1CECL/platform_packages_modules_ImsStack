...
public:
    ...
    MOCK_METHOD(IMS_SINT32, GetSubConsecutiveRetryCntForRegForbiddenInWifi, (), (const, override));
    MOCK_METHOD(IMS_SINT32, GetRegRetrySip305CodePolicy, (), (const, override));
    MOCK_METHOD(IMS_SINT32, GetReleasePdnDelaySecAfterTempPlmnBlock, (), (const, override));
    ...
    MOCK_METHOD(IMS_SINT32, GetRegRetryCountPerPcscfWithRaTime, (), (const, override));
    ...
    MOCK_METHOD(ImsVector<IMS_SINT32>&, GetEmergencyOverImsSupportedRats, (), (override));
    ...
    MOCK_METHOD(ImsVector<IMS_SINT32>&, GetUnavailableFeaturesInLimitedReg, (), (override));
